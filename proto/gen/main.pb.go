...
const file_main_proto_rawDesc = "" +
	...
	"\n" +
	"main.proto\x12\n" +
	"calculator\x1a\x17validate/validate.proto\x1a\x1cgoogle/api/annotations.proto\":\n" +
	"\n" +
	"AddRequest\x12\x15\n" +
	...
	"\vChatMessage\x12!\n" +
	"\amessage\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\amessage2\xdf\x02\n" +
	"\n" +
	"Calculator\x12U\n" +
	"\x03Add\x12\x16.calculator.AddRequest\x1a\x17.calculator.AddResponse\"\x1d\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/v1/calculator/add\x12t\n" +
	"\x11GenerateFibonacci\x12\x1c.calculator.FibonacciRequest\x1a\x1d.calculator.FibonacciResponse\" \x82\xd3\xe4\x93\x02\x1a\x12\x18/v1/calculator/fibonacci0\x01\x12F\n" +
